...
--Lowest HP Party Pet Member
  ...
  and UnitExists("partypet1")
  and not UnitIsDeadOrGhost("partypet1") then
    if UnitBuffID("partypet1", 53563) == nil then
      _castSpell(53563, "partypet1")
    end
  end
  if UnitClass("party2") == "Warlock" 
  and UnitExists("partypet2")
  and not UnitIsDeadOrGhost("partypet2") then
